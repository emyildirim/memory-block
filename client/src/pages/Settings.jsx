            ...
            <div className="memory-card rounded-lg shadow p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <img
                    src={`https://www.metiny.ca/resume/profile-photo.jpeg`}
                    alt="icon"
                    className="w-12 h-12 rounded-full"
                  />
                  <div>
                    <p className="font-medium" style={{ color: 'var(--text-primary)' }}>Erkam Yildirim</p>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a 
                    href="https://www.linkedin.com/in/metin-ca/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-sm hover:opacity-80 transition-opacity"
                    style={{ color: 'var(--accent-color)' }}
                  >
                    linkedin.com/in/metin-ca
                  </a>
                </div>
