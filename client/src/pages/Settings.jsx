      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Developer Section */}
            <div className="memory-card rounded-lg shadow p-6">
              <h2 className="text-xl font-semibold mb-4" style={{ color: 'var(--text-primary)' }}>Developer</h2>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <svg className="w-6 h-6" style={{ color: 'var(--accent-color)' }} fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-1 9V7h2v4h4v2h-4v4h-2v-4H7v-2h4z"/>
                  </svg>
                  <div>
                    <p className="font-medium" style={{ color: 'var(--text-primary)' }}>Metin Yildiz</p>
                    <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Full Stack Developer</p>
                  </div>
                </div>
                
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5" style={{ color: 'var(--accent-color)' }} fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                  <a 
                    href="https://linkedin.com/in/metin-yildiz" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-sm hover:opacity-80 transition-opacity"
                    style={{ color: 'var(--accent-color)' }}
                  >
                    linkedin.com/in/metin-yildiz
                  </a>
                </div>
                
                <div className="pt-2 text-xs" style={{ color: 'var(--text-secondary)' }}>
                  <p>Built with passion using React, Node.js, and MongoDB</p>
                </div>
              </div>
            </div>
          </div>
